...
type
  ...
  Tf_option = class(TForm)
    ...
    GuideLockX: TFloatSpinEditEx;
    GuideLockY: TFloatSpinEditEx;
    ...
    GuideDriftAbortNum: TSpinEditEx;
    ...
    FloatSpinEditMa11: TFloatSpinEditEx;
    FloatSpinEditMa12: TFloatSpinEditEx;
    FloatSpinEditMa13: TFloatSpinEditEx;
    FloatSpinEditMa8: TFloatSpinEditEx;
    FloatSpinEditMa9: TFloatSpinEditEx;
    FloatSpinEditMi10: TFloatSpinEditEx;
    FloatSpinEditMi11: TFloatSpinEditEx;
    FloatSpinEditMi12: TFloatSpinEditEx;
    FloatSpinEditMi13: TFloatSpinEditEx;
    FloatSpinEditMi8: TFloatSpinEditEx;
    FloatSpinEditMi9: TFloatSpinEditEx;
    ...
    FloatSpinEditMa2: TFloatSpinEditEx;
    FloatSpinEditMa3: TFloatSpinEditEx;
    FloatSpinEditMa4: TFloatSpinEditEx;
    FloatSpinEditMa5: TFloatSpinEditEx;
    FloatSpinEditMa6: TFloatSpinEditEx;
    FloatSpinEditMa7: TFloatSpinEditEx;
    FloatSpinEditMi1: TFloatSpinEditEx;
    FloatSpinEditMa1: TFloatSpinEditEx;
    FloatSpinEditMi2: TFloatSpinEditEx;
    FloatSpinEditMi3: TFloatSpinEditEx;
    FloatSpinEditMi4: TFloatSpinEditEx;
    FloatSpinEditMi5: TFloatSpinEditEx;
    FloatSpinEditMi6: TFloatSpinEditEx;
    FloatSpinEditMi7: TFloatSpinEditEx;
    Label108: TLabel;
    LabelMa2: TLabel;
    LabelMa3: TLabel;
    LabelMa4: TLabel;
    ...
    DomeFlatTelescopeAz: TFloatSpinEditEx;
    DomeFlatTelescopeAlt: TFloatSpinEditEx;
    DomeBox: TGroupBox;
    Label102: TLabel;
    Label103: TLabel;
    Label104: TLabel;
    ...
    ClippingHigh: TFloatSpinEditEx;
    BPMsigma: TFloatSpinEditEx;
    CameraAutoCoolTemp: TFloatSpinEditEx;
    FlatMinExp: TFloatSpinEditEx;
    ...
    astap: TGroupBox;
    SettlePixel: TFloatSpinEditEx;
    SlewExp: TFloatSpinEditEx;
    SourcesLimit: TSpinEditEx;
    PlatesolveWait: TSpinEditEx;
    SlewBin: TSpinEditEx;
    SlewDelay: TSpinEditEx;
    MinutesPastMeridian: TSpinEditEx;
    MinutesPastMeridianMin: TSpinEditEx;
    MeridianFlipPauseTimeout: TSpinEditEx;
    SettleMinTime: TSpinEditEx;
    SettleMaxTime: TSpinEditEx;
    CalibrationDelay: TSpinEditEx;
    MaxAdu: TSpinEditEx;
    ASTAPSearchRadius: TSpinEditEx;
